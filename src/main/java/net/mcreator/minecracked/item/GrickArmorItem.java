...
public class GrickArmorItem extends MinecrackedModElements.ModElement {
	@ObjectHolder("minecracked:grick_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("minecracked:grick_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("minecracked:grick_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("minecracked:grick_armor_boots")
	public static final Item boots = null;
	public GrickArmorItem(MinecrackedModElements instance) {
		super(instance, 14);
	}
