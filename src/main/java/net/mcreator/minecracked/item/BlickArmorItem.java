...
public class BlickArmorItem extends MinecrackedModElements.ModElement {
	@ObjectHolder("minecracked:blick_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("minecracked:blick_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("minecracked:blick_armor_leggings")
